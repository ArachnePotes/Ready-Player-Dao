function mapper_chart(data) {
    ...
    rubber_to_chart = {
      ...
      coin_id: 1, //getCoinID(data.symbol),
    };
    return rubber_to_chart}
  
  function geeko_rubber_data_eve() {
      var Time = 1811000;
      url = "https://api.coingecko.com/api/v3/coins/solana/?localization=true?tickers=true?community_data=true?developer_data=true?vs_currency=usd,eth,btc,matic";
      fetch(url, {
        method: 'GET',
