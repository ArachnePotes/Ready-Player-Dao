...
function geeko_shaped_data_loka() {
  var Time = 1800000;
  url =
    'https://api.coingecko.com/api/v3/coins/league-of-kingdoms/?localization=true?tickers=true?community_data=true?developer_data=true?vs_currency=usd,eth,btc,matic';
  fetch(url, {
    method: 'GET',
    ...
    .then(setTimeout('geeko_shaped_data_loka()', Time));
}


geeko_shaped_data_loka();