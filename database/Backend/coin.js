...
export async function updateCoin(coin_shaped){
  /**
  rubber_to_coin =  rubber_to_coin =  {
  ...
  maxSupply = ?
  WHERE (coin_id = ?);` ,  [
    coin_shaped['coin_rank'],
    coin_shaped['coin_Name'],
    coin_shaped['coin_slug'],
    coin_shaped['coin_symbol'],
    coin_shaped['coin_address'],
    coin_shaped['circulatingSupply'],
    coin_shaped['totalSupply'],
    coin_shaped['maxSupply'],
    coin_shaped['coin_id']
  ])
