...
function mapper_chart(data) {
  ...
  */
  ...
  function geeko_rubber_data_ChampAsc() {
      var Time = 1800000;
      url = "https://api.coingecko.com/api/v3/coins/champions-ascension/?localization=true?tickers=true?community_data=true?developer_data=true?vs_currency=usd,eth,btc,matic"
      fetch(url, {
