...
function mapper_chart(data) {
  ...
  */
  ...
  function geeko_rubber_data_Castaways() {
      var Time = 1800000;
      url = "https://api.coingecko.com/api/v3/coins/castaways-genesis/?localization=true?tickers=true?community_data=true?developer_data=true?vs_currency=usd,eth,btc,matic"
      fetch(url, {
      ...
      .then( setTimeout("geeko_rubber_data_Castaways()",Time))    
  }
  
  
  geeko_rubber_data_Castaways();