function mapper_chart(data) {
    ...
    */
    rubber_to_chart = {
      ...
      coin_id: 6, //getCoinID(data.symbol),
    };
    /*
    console.log(
...
/*  
  ...
  */
  ...
  function geeko_rubber_data_EVE() {
      var Time = 1800000;
      url = "https://api.coingecko.com/api/v3/coins/eve-token/?localization=true?tickers=true?community_data=true?developer_data=true?vs_currency=usd,eth,btc,matic"
      fetch(url, {
      ...
      .then( setTimeout("geeko_rubber_data_EVE()",Time))    
  }
  
  
  geeko_rubber_data_EVE();